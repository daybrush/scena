...
import Editor, { EditorManagerInstance } from "../EditorManager";
...
export default class ClipboardManager {
    ...
    // }
    // public copyImage() {
        // const targets = this._editorRef.c.getSelectedTargets();
    ...
    //     Debugger.log("copy scena data", SavedScenaData);
    ...
    //         Debugger.log("paste scena data", scenaDatas);
