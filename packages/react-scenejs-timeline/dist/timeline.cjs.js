...
var drag = require('@daybrush/drag');
...
function findElementIndexByPosition(elements, pos) {
  return utils.findIndex(elements, function (el) {
...
function checkFolded(foldedInfo, names) {
  var index = utils.findIndex(names, function (name, i) {
...
function (_super) {
  ...
  __proto.renderKeytimes = function () {
    ...
    for (var time = 0; time <= maxTime; ++time) {
      keytimes.push(React.createElement("div", {
        key: time,
        "data-time": time,
  ...
  __proto.render = function () {
    ...
    }, this.renderKeytimes()), React.createElement(KeyframeCursor, {
      ref: ref(this, "cursor")
    }))));
  };
  ...
  __proto.componentDidMount = function () {
    ...
    utils.addEvent(this.getElement(), "wheel", function (e) {
      var delta = e.deltaY;
    ...
    drag.drag(this.cursor.getElement(), {
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    return React.createElement("div", {
      ...
      onClick: this.add
    }, "+"))), React.createElement(KeytimesArea, {
...
function (_super) {
  ...
  __proto.renderList = function () {
    ...
    if (length >= 2 && !hasProperties) {
      var index = utils.findIndex(frames, function (_a) {
        var value = _a[2];
      ...
      keyframeGroups.push(React.createElement(KeyframeGroup, {
        key: "group",
        id: time + "," + nextTime,
    ...
    frames.forEach(function (_a, i) {
      ...
      if (frames[i + 1]) {
        ...
        if (iterationTime === 0 && nextIterationTime === 0 || iterationTime === duration && nextIterationTime === duration) {
          keyframeDelays.push(React.createElement(KeyframeDelay, {
      ...
      if (i === 0 && time === 0 && iterationTime === 0 && utils.isUndefined(value) && !hasProperties) {
        return;
      }
      ...
      if (frames[i + 1]) {
        ...
        if (!isItScene && !utils.isUndefined(value) && !utils.isUndefined(nextValue) && valueText !== nextValueText && hasProperties) {
          keyframeLines.push(React.createElement(KeyframeLine, {
      ...
      keyframes.push(React.createElement(Keyframe, {
        key: "keyframe" + i,
        id: "" + time,
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    for (var key in timelineInfo) {
      ...
      keyframesList.push(React.createElement(Keyframes, {
    ...
    }, keyframesList.concat([React.createElement(KeyframeCursor, {
      key: "cursor",
      ref: ref(this, "cursor")
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    for (var id in timelineInfo) {
      ...
      var folded = checkFolded(foldedInfo, propertiesInfo.keys);
      properties.push(React.createElement(Property, {
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    for (var id in timelineInfo) {
      ...
      var selected = selectedProperty === id;
      var folded = checkFolded(foldedInfo, propertiesInfo.keys);
      values.push(React.createElement(Value, {
  ...
  __proto.edit = function (target, value) {
    ...
    var index = utils.findIndex(this.values, function (v) {
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    return React.createElement("div", {
    ...
    }, React.createElement(PropertiesArea, {
      ref: ref(this, "propertiesArea"),
      timelineInfo: timelineInfo,
      selectedProperty: selectedProperty
    }), React.createElement(ValuesArea, {
      ...
      timelineInfo: timelineInfo,
      selectedProperty: selectedProperty
    }), React.createElement(KeyframesArea, {
...
function (_super) {
  ...
  __proto.render = function () {
    ...
    }, attributes), this.renderStyle(), React.createElement(ControlArea, {
      ...
      drag.drag(element, {
        ...
        dragstart: function (_a) {
          ...
          if (dragTarget) {
            ...
            var property = utils.find(properties, function (p) {
