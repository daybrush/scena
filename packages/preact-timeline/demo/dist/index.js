...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('prop-types')) :
	typeof define === 'function' && define.amd ? define(['prop-types'], factory) :
	(global = global || self, factory(global['prop-types']));
}(this, function (PropTypes) { 'use strict';
	...
	***************************************************************************** */
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(ElementComponent, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(ControlArea, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeyframeCursor, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeytimesArea, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeyframeGroup, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeyframeDelay, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeyframeLine, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(KeyframesArea, _super);
	...
	/*#__PURE__*/
	function (_super) {
	  __extends$3(PropertiesArea, _super);
	...
	function (_super) {
	  ...
	  function Timeline(props) {
	    ...
	    _this.state = __assign$2({}, _this.state, _this.initScene(_this.props.scene));
	  ...
	  __proto.render = function () {
	    ...
	    return createElement("div", __assign$2({
	...
	*/
	...
	var OPTIONS = [DURATION, FILL_MODE, DIRECTION$1, ITERATION_COUNT$1, DELAY$1, EASING, PLAY_SPEED$1];
	...
	*/
	...
	function exportCSS(id, css) {
	  var styleId = PREFIX$1 + "STYLE_" + toId(id);
	...
	*/
	...
	function isDirectionReverse(iteration, iteraiontCount, direction) {
	  if (direction === REVERSE$1) {
	    return true;
	  } else if (iteraiontCount !== INFINITE && iteration === iteraiontCount && iteraiontCount % 1 === 0) {
	    return direction === (iteration % 2 >= 1 ? ALTERNATE_REVERSE$1 : ALTERNATE$1);
	  }

	  return direction === (iteration % 2 >= 1 ? ALTERNATE$1 : ALTERNATE_REVERSE$1);
	}
	/**
	...
	*/
	...
	var setters = ["id", ITERATION_COUNT$1, DELAY$1, FILL_MODE, DIRECTION$1, PLAY_SPEED$1, DURATION, PLAY_SPEED$1, ITERATION_TIME, PLAY_STATE];
	...
	*/
	...
	function (_super) {
	  ...
	  __proto.getActiveDuration = function (delay) {
	    var state = this.state;
	    var count = state[ITERATION_COUNT$1];

	    if (count === INFINITE) {
	      return Infinity;
	    }

	    return (delay ? state[DELAY$1] : 0) + this.getDuration() * count;
	  };
	  /**
	  ...
	  __proto.getUnitTime = function (time) {
	    if (isString(time)) {
	      ...
	      if (unit === "%") {
	        ...
	        return toFixed$2(parseFloat(time) / 100 * duration);
	      } else if (unit === ">") {
	  ...
	  __proto.setIteration = function (iterationCount) {
	    ...
	    var maxIterationCount = state[ITERATION_COUNT$1] === INFINITE ? Infinity : state[ITERATION_COUNT$1];
	...
	function (_super) {
	  ...
	  __proto.setDuration = function (duration) {
	    ...
	    if (originalDuration > 0) {
	      ...
	      this.times = times.map(function (time) {
	        var time2 = toFixed$2(time * ratio_1);
	  ...
	  * @param - The target frame
	  ...
	  __proto.toCSS = function (playCondition, parentDuration, states) {
	    ...
	    }) + " {" + ANIMATION + "-play-state: paused;}\n    @" + KEYFRAMES + " " + PREFIX$1 + "KEYFRAMES_" + id + "{" + this._toKeyframes(duration, finiteStates, direction) + "}";
	  };
	  /**
	  ...
	  __proto.exportCSS = function (playCondition, duration, options) {
	    ...
	    var isParent = options && !isUndefined(options[ITERATION_COUNT$1]);
	  ...
	  __proto._toKeyframes = function (duration, states, direction) {
	    ...
	    var entries = getEntries$1(times, states);
	    var lastEntry = entries[entries.length - 1]; // end delay time

	    lastEntry[0] < duration && addEntry$1(entries, duration, lastEntry[1]);
	    var prevTime = -1;
