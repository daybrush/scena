...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@daybrush/drag'), require('@daybrush/utils'), require('@egjs/axes')) :
  typeof define === 'function' && define.amd ? define(['@daybrush/drag', '@daybrush/utils', '@egjs/axes'], factory) :
  (global = global || self, global.Timeline = factory(global.utils, global.utils, global.eg.Axes));
}(this, function (drag, utils, Axes) { 'use strict';
  ...
  function () {
    ...
    __proto.initElement = function (scene, parentEl) {
      ...
      var _loop_1 = function (property) {
        ...
        utils.toArray(propertiesAreaEl.querySelectorAll("[data-property=\"" + properties.slice(0, -1).join("///").replace(/"/g, "\\\"") + "\"]")).forEach(function (el) {
    ...
    __proto.wheelZoom = function () {
      ...
      axes.connect("zoom", new Axes.PinchInput(keyframesScrollAreaEl, {
        scale: 0.7,
    ...
    __proto.fold = function () {
      ...
      propertiesAreaEl.addEventListener("click", function (e) {
        var target = getTarget(e.target, function (el) {
          return utils.hasClass(el, PREFIX + "properties");
        });
        ...
        infos.forEach(function forEach(info, i, arr) {
          if (utils.isArray(info)) {
            ...
            if (isFold) {
              utils.removeClass(keyframeEl, FOLD_CLASS);
              utils.removeClass(info, FOLD_CLASS);
            } else {
              utils.addClass(keyframeEl, FOLD_CLASS);
              utils.addClass(info, FOLD_CLASS);
            }
          }
        });
      });
    ...
    __proto.drag = function () {
      ...
      function click(e, clientX) {
        var target = getTarget(e.target, function (el) {
          return utils.hasClass(el, PREFIX + "keyframe");
        });
      ...
      drag.drag(keyframesScrollAreaEl, {
        events: ["touch"],
        container: window,
        drag: function (_a) {
