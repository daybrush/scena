...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function handleComponentVNode(vnode) {
      ...
      if (tag.defaultProps) {
        extend$1(vnode.attributes, tag.defaultProps);
      }

      if (a) {
        extend$1(vnode.attributes, a);
      }
    }
    ...
    __proto.prototype = Component$1$1.prototype;
    __proto.prototype = new F();
    __proto.isPureReactComponent = true;
